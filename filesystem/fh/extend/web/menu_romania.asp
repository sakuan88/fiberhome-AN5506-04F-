...
<link type="text/css" rel="stylesheet" href="./style/frame_romania.css"/>
...
<script type="text/javascript" src="./js/frame_romania.js"></script>
...
function LoadFrame()
{
	...
	document.getElementById("headerLogoImg").style.background = "url(" 
		+ getLogoVerCtrl(ispName, ispMinorNameCode, page_style) + ") center center no-repeat";
}
</script>
</head>
