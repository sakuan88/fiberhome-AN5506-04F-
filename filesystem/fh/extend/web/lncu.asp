...
loginPageAccessCheck(ispName, ispMinorNameCode, page_style, "lncu.asp");
  ...
  <table valign="middle" height="100%" width="100%">
    <tbody>
      <tr valign="middle" height="80%">
        <td width="33%"></td>
        <td width="33%"><table valign="middle" align="center" background="images/login_admin.png" border="0" width="935" height="415">
            <tbody>
              <tr>
                <td width="47%"><table valign="middle" height="415" width="100%" border="0">
                    <tbody>
                      ...
                      <tr height="10%">
                        <td class="STYLE5"><% getCfgGeneral(1, "DeviceType"); %></td>
                      </tr>
                      <tr height="30%">
                        <td></td>
                      </tr>
                                ...
                                <td width="100%" ><table align="center" border="0" height="100%" width="100%">
                                    <tbody>
                                      <tr>
                                        ...
                                        <td width="5%"></td>
                                        <td width="25%" id="td_regist" align="center"><input id="devReg" type="button" class="STYLE2" value="设备注册" onClick="location='./devregist/register_lncu.asp'">
                                        </td>
                                        <td></td>
                                      </tr>
                                    </tbody>
