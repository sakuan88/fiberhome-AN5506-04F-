...
function initValue()
{
	...
	else if(ispNameCode == 15 || ispNameCode == 26)	//GLOBE 巴西TIM
		setDisplay("sysUpTime_tr", "");

	if(ispNameCode == 4 || ispNameCode == 16 || ispNameCode == 26)//3BB/viettel 巴西TIM
		setDisplay("serial_number_tr", "");

	if(ispNameCode == 26)//巴西TIM
		setDisplay("wan_mac_tr", "");
	...
	if(DEV_TYPE == '01A9G')//modify by 吴小娟, 20180525, 原因: 01A9G不需参数LOID.需求来源:朱木成
	{
		setDisplay("loid_tr", "none");		
	}
...
<form method="post" name="deviceinf" id="deviceinf">
  ...
  <table class="tabal_bg" border="0" cellpadding="0" cellspacing="1" width="100%">
    <tbody>
      ...
      <tr id ="serial_number_tr"  style="display: none">
      ...
      <tr id = "wan_mac_tr" style="display: none">
        <td class="tabal_left" width="25%" id="wan_mac_title">MAC Address</td>
        <td class="tabal_right"><% getCfgGeneral(1, "wan_mac"); %></td>
      </tr>
    </tbody>
  </table>
  <table id="catv_rf" class="tabal_bg" border="0" cellpadding="0" cellspacing="1" width="100%">
    <tbody>
      <tr >
        <td class="tabal_left" width="25%" id="catv_enable_title">CATV Enable</td>
