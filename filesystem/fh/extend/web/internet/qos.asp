...
function initTranslation()
{
	...
	e.innerHTML = _("qos_class802Title");
	...
	e.innerHTML = _("qos_classMinTitle");
	...
	e.innerHTML = _("qos_classMaxTitle");
	...
	e.innerHTML = _("qos_classProtocolTitle");
	...
	e.innerHTML = _("qos_classDSCPTitle");
	...
	e.innerHTML = _("qos_priServiceTitle");
	e = document.getElementById("qos_priServiceTitle");
	e.innerHTML = _("qos_priServiceTitle");
	e = document.getElementById("priOption_chose");
	...
	e = document.getElementById("qos_classRuleCancel");
	e.value = _("qos_classRuleCancel");
	e = document.getElementById("qos_classRuleCancel2");
	e.value = _("qos_classRuleCancel");
	e = document.getElementById("qos_basicApply");
	e.value = _("qos_classRuleApply");	
	e = document.getElementById("qos_basicCancel");
	e.value = _("qos_classRuleCancel");
	e = document.getElementById("qos_enableTitle");
	e.value = _("qos_enableTitle");
	e = document.getElementById("qos_disableTitle");
	e.value = _("qos_disableTitle");	
...
function selectLine(table, id)
{
	...
	else						//classification
	{
		...
		else
		{
			...
			getElement('qos_classDSCP').value = getElement("qos_classDSCP_" + classNo).innerHTML;
			getElement('qos_class802').value = getElement("qos_class802_" + classNo).innerHTML;
			for(var i = 0; i < 3; i++)
			{
				...
				else
				{
					...
					var curClassType = getElement("qos_classType_" + classNo + "_" + i).innerHTML;
					switchType((i+1), curClassType);
					
					if(curClassType == "LANInterface")
					{
						showSelectNodeByText(getElement("qos_classMinSelect" + (i+1)), getElement("qos_classMin_" + classNo + "_" + i).innerHTML);
						showSelectNodeByText(getElement("qos_classMaxSelect" + (i+1)), getElement("qos_classMax_" + classNo + "_" + i).innerHTML);
					}
					else
					{
...
function clickRemoveAll(tabTitle)
{
	...
	{
		checkNodes = getElement('qos_pri_removeFlag');
		go2Location = "/goform/qos_pri_delete_all";
		if(qos_pri_ruleSum  == 0)
		{			
	 		alert(_("rule_noRuleAlert"));
	   		return;
	...
	{
		checkNodes = getElement('qos_class_removeFlag');
		go2Location = "/goform/qos_class_delete_all";
		if(qos_class_ruleSum  == 0)
		{			
	 		alert(_("rule_noRuleAlert"));
	   		return;
...
function switchType(typeID, typeValue)
{
	...
	if(typeValue != 0)
		showSelectNodeByValue(getElement("qos_classProtocol" + typeID), "TCP");
}
              ...
              <tbody>
                <tr>
                  ...
                  <td class="tabal_right" width="75%"><select name="qos_priService" size="1" style="width:150px;">
                      <option value="0" id="priOption_chose">请选择</option>
            ...
            <tbody>
              <tr>
                ...
                <td class="tabal_right"><input type="submit" id="qos_enableTitle" value="应用" class="submit" onClick="qosEnable(1)">
                  <input type="submit" id="qos_disableTitle" value="禁用" class="submit" onClick="qosEnable(0)">
