...
function selectLine(id)
{
	...
	if (objTR != null)
	{
		...
		{
			getElement("ip_bw_ctl_descrip").value = getElement("ip_bw_ctl_descrip_" + temp).innerHTML;

			var curIP = getElement("ip_bw_ctl_ip_" + temp).innerHTML;
...
function clickRemoveAll(tabTitle)
{
	...
	document.location = "/goform/ip_bandwidth_ctl_delete_all";    
