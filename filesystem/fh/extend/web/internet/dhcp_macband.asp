...
function selectLine(id)
{
	...
	if (objTR != null)
	{
		...
		{
			document.getElementById("dhcp_mac").value = document.getElementById("dhcp_mac_" + temp).innerHTML;
			document.getElementById("dhcp_ip").value = document.getElementById("dhcp_ip_" + temp).innerHTML.split('-')[0].split(':')[0];
		}
