...
<script type="text/javascript" src="/js/wan_new.js"></script>
<title>WAN</title>
...
var WEB_DATAMODEL_181 = '<% getCfgGeneral(1, "WEB_DATAMODEL_181"); %>';
                            ...
                            <table id="AFTR_value_table" class="tabal_bg" border="0" cellpadding="0" cellspacing="1" width="100%" style="display: none;" >
                              <tbody>
                                <tr>
                                  ...
                                  <td class="tabal_right" width="75%"><input name="AFTR_value" id="AFTR_value" size="15"  maxlength=40 style="width: 150px;" type="text" value="<% getCfgGeneral(1, "aftr_value"); %>">
                                  </td>
                                </tr>
                              </tbody>
                            </table>
                          ...
                          <td><table id="static_ipv6" class="tabal_bg" border="0" cellpadding="0" cellspacing="1" width="100%" style="display: none;" >
                              <tbody>
                                <tr>
                                  ...
                                  <td class="tabal_right"><input name="staticIp_ipv6" id="staticIp_ipv6" maxlength=128 size=50 value="<% getCfgGeneral(1, "staticIp_ipv6"); %>">
                                  </td>
                                </tr>
                                <tr>
                                  <td class="tabal_left" id="Prefix_Length_title">IPv6 Prefix Length</td>
                                  <td class="tabal_right"><input name="Prefix_Length" id="Prefix_Length" maxlength=128 size=50 value="<% getCfgGeneral(1, "Prefix_Length"); %>">
                                  </td>
                                </tr>
                                <tr>
                                  <td class="tabal_left" id="wStaticGateway_ipv6">Default Gateway</td>
                                  <td class="tabal_right"><input name="IPv6_Gateway" id="IPv6_Gateway" maxlength=128 size=50 value="<% getCfgGeneral(1, "IPv6_Gateway"); %>">
                                  </td>
                                </tr>
                                <tr>
                                  <td class="tabal_left" id="wStaticPriDns_ipv6">Primary DNS Server</td>
                                  <td class="tabal_right"><input name="IPv6_Pri_DNS" id="IPv6_Pri_DNS" maxlength=128 size=50 value="<% getCfgGeneral(1, "IPv6_Pri_DNS"); %>"></td>
                                </tr>
                                <tr>
                                  <td class="tabal_left" id="wStaticSecDns_ipv6">Secondary DNS Server</td>
                                  <td class="tabal_right"><input name="IPv6_Sec_DNS" id="IPv6_Sec_DNS" maxlength=128 size=50 value="<% getCfgGeneral(1, "IPv6_Sec_DNS"); %>"></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  ...
                                  <td class="tabal_right"><input name="IPv6_prefix" id="IPv6_prefix" maxlength=128 size=50 value="<% getCfgGeneral(1, "IPv6_prefix"); %>">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td class="tabal_right"><select name="Prefix_dhcp" id="Prefix_dhcp" size="1">
                                      <option value="PrefixDelegation" id="Prefix_mode"></option>
                                    </select>
                                  </td>
                                </tr>
                              </tbody>
