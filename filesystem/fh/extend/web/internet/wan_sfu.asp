...
<script type="text/javascript" src="/js/wan_sfu.js"></script>
<title>WAN</title>
...
var dslite_enable_arr = dslite_enable.split("|");
var aftr_mode = '<% getCfgGeneral(1, "aftr_mode"); %>';
var aftr_mode_arr = aftr_mode.split("|");
var aftr_value = '<% getCfgGeneral(1, "aftr_value"); %>';
var aftr_value_arr = aftr_value.split("|");
...
var ipv6_state_arr = ipv6_state.split("|");
...
var WEB_WAN_CONN_TRIGGER = '<% getCfgGeneral(1, "WEB_WAN_CONN_TRIGGER"); %>';
...
var wanIndexArray = wan_Index.split("|");
var curWANIndex;
...
var Prefix_Length = '<% getCfgGeneral(1, "Prefix_Length");%>';
var Prefix_Length_arr = Prefix_Length.split("|");
...
//var prefix_v6_dhcp_arr = prefix_v6_dhcp.split("|");
//var prefix_v6_pppoe_arr = prefix_v6_pppoe.split("|");
var v6_addr_mode = '<% getCfgGeneral(1, "v6_addr_mode"); %>';
var v6_addr_mode_arr = v6_addr_mode.split("|");

var WEB_DSLITE = '<% getCfgGeneral(1, "WEB_DSLITE");%>';
var pppoeUserExtend_flag = '<% getCfgGeneral(1, "WEB_PPPOE_USER_EXTEND_LEN");%>';

var multiRouteWanFlag = '<% getCfgGeneral(1, "WEB_MULTI_ROUTE_WAN"); %>';
var singlePortMultiRouteWanFlag = '<% getCfgGeneral(1, "WEB_SINGLE_PORT_MULTI_ROUTE_WAN"); %>';
...
<table border="0" cellpadding="0" cellspacing="0" height="5" width="100%">
  <tbody>
    ...
    <!--ok-->
    <tr>
      <td height="5"><span id="fw_userResetPrompt"></span></td>
    </tr>
    <tr>
      <td><form id="ConfigForm" method="post" action="/goform/WanCfg" onSubmit="return checkValue()">
          <div id="ConfigForm1">
              ...
              <tbody>
                <tr>
                  <td><table class="tabal_bg" cellpadding="0" cellspacing="1" width="100%">
                      <tbody>
                        <tr id="TrWanEnable" style="display: none">
                        ...
                        <tr>
                          <td id="wan_servicetypeTitle" class="tabal_left">Service Type</td>
                          <td class="tabal_right" ><select name="wan_connectionmode" id="wan_connectionmode" size="1" style="width:200px;" onChange="WanIndexSwitch(this.value);">
                              <option value="0" >TR069</option>
                              <option value="1" selected="selected">INTERNET</option>
                              <option value="2">TR069_INTERNET</option>
                              <option value="3">MUTICAST</option>
                              <option value="4">VOIP</option>
                              <option value="5">VOIP_INTERNET</option>
                              <option value="6">IPTV</option>
                              <option value="16">TR069_VOIP</option>
                              <option value="17">TR069_VOIP_INTERNET</option>
                              <option value="100">OTHER</option>
                            </select></td>
                        </tr>
                        <tr>
                          <td class="tabal_left" id="wan_connectionTypeTitle">Connection Type</td>
                        ...
                        <tr id="tr_vlan">
                          <td id="wan_vid_title" class="tabal_left">VLAN ID</td>
                        ...
                        <tr id="tr_priority">
                          <td id="wan_priorityTitle" class="tabal_left">Priority</td>
                        ...
                        <tr>
                          <td colspan="2"><table id="tb_nat_dns" class="tabal_bg" border="0" cellpadding="0" cellspacing="1" width="100%">
                              <tbody>
                                <tr>
                                  <td class="tabal_left" width="25%">NAT</td>
                                  <td class="tabal_right"><select name="nat_enable" id="nat_enable" size="1" style="width:200px;" >
                                      <option value="1" id="nat_enabletitle" selected="selected">Enable</option>
                                      <option value="0" id="nat_disabletitle" >Disable</option>
                                    </select></td>
                                </tr>
                                <tr>
                                  <td id="lan_dns_relay" class="tabal_left">DNS Relay</td>
                                  <td class="tabal_right"><select name="dns_enable" id="dns_enable" size="1" style="width:200px;" >
                                      <option value="1" id="dns_enabletitle" selected="selected">Enable</option>
                                      <option value="0" id="dns_disabletitle" >Disable</option>
                                    </select></td>
                                </tr>
                                <tr id="tr_mtu">
                                  <td id="wan_MTUTitle" class="tabal_left">MTU</td>
                                  <td class="tabal_right"><input name="wan_mtu" id="wan_mtu" size="15"  style="width: 200px;" type="text">
                            ...
                            <table id="AFTR_value_table" class="tabal_bg" border="0" cellpadding="0" cellspacing="1" width="100%" style="display: none;" >
                              <tbody>
                                <tr>
                                  ...
                                  <td class="tabal_right" width="75%"><input name="AFTR_value" id="AFTR_value" size="15"  maxlength=40 style="width: 150px;" type="text">
                                  </td>
                                </tr>
                              </tbody>
                            </table>
                    ...
                    <table id="static" class="tabal_bg" border="0" cellpadding="0" cellspacing="1" width="100%" style="display: none;" >
                      <tbody>
                        <tr class="tabal_head">
                          <td id="wStaticMode">Static Mode</td>
                        </tr>
                        <tr>
                          <td><table id="static_ipv4_table" class="tabal_bg" border="0" cellpadding="0" cellspacing="1" width="100%" style="display: none;" >
                              <tbody>
                                <tr>
                        ...
                        <tr>
                          <td><table id="static_ipv6" class="tabal_bg" border="0" cellpadding="0" cellspacing="1" width="100%" style="display: none;" >
                              <tbody>
                                <tr>
                                  <td class="tabal_left" width="25%" id="wStaticIpv6">IPv6 Address</td>
                                  <td class="tabal_right"><input name="staticIp_ipv6" id="staticIp_ipv6" maxlength=128 size=50>
                                  </td>
                                </tr>
                                <tr>
                                  <td class="tabal_left" id="Prefix_Length_title">IPv6 Prefix Length</td>
                                  <td class="tabal_right"><input name="Prefix_Length" id="Prefix_Length" maxlength=128 size=50>
                                  </td>
                                </tr>
                                <tr>
                                  <td class="tabal_left" id="wStaticGateway_ipv6">Default Gateway</td>
                                  <td class="tabal_right"><input name="IPv6_Gateway" id="IPv6_Gateway" maxlength=128 size=50>
                                  </td>
                                </tr>
                                <tr>
                                  <td class="tabal_left" id="wStaticPriDns_ipv6">Primary DNS Server</td>
                                  <td class="tabal_right"><input name="IPv6_Pri_DNS" id="IPv6_Pri_DNS" maxlength=128 size=50></td>
                                </tr>
                                <tr>
                                  <td class="tabal_left" id="wStaticSecDns_ipv6">Secondary DNS Server</td>
                                  <td class="tabal_right"><input name="IPv6_Sec_DNS" id="IPv6_Sec_DNS" maxlength=128 size=50></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  ...
                                  <td class="tabal_right"><input name="IPv6_prefix" id="IPv6_prefix" maxlength=128 size=50>
                                    <span id="prefix_length_prompt" class="gray">&nbsp; (such as 2001:a::/64, prefix length:(48-64))</span></td>
                                </tr>
                              </tbody>
                            </table></td>
                        </tr>
                    ...
                    <table id="dhcp" class="tabal_bg" border="0" cellpadding="0" cellspacing="1" width="100%" style="display: none;" >
                      <tbody>
                        <tr class="tabal_head">
                          <td id="wDhcpMode">DHCP Mode</td>
                        </tr>
                        <!--add begin by 吴小娟, 20110601, 原因: 新增DHCP连接IP等-->
                        <tr>
                          <td><table id="dhcp_ipv4_table" class="tabal_bg" border="0" cellpadding="0" cellspacing="1" width="100%" style="display: none;" >
                              <tbody>
                        ...
                        <!--tr>
									     ...
									     <tr id="wDhcpCon_secDNS_tr">
										        ...
										        <td class="tabal_right"><input type="text"   name="option60_value" id="option60_value" style="width:200px;" value="<% getCfgGeneral(1, "option60_value"); %>">
										        </td>
								         </tr-->
                        <tr>
                          <td><table id="dhcp_ipv6" class="tabal_bg" border="0" cellpadding="0" cellspacing="1" width="100%" style="display: none;" >
                              <tbody>
                                <tr>
                                ...
                                <tr>
                                  ...
                                  <td class="tabal_right"><select name="Prefix_dhcp" id="Prefix_dhcp" size="1">
                                      <option value="0" id="Prefix_mode">Prefix Delegate</option>
                                    </select>
                                  </td>
                                </tr>
                              </tbody>
                    ...
                    <table id="pppoe" class="tabal_bg" border="0" cellpadding="0" cellspacing="1" width="100%" style="display: none;" >
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="tabal_right"><input type="password" name="pppoePass" id="pppoePass" maxlength=31 style="width:200px;" >
                        ...
                        <!--tr>
								        ...
								        <td class="tabal_right"><input type="password" name="pppoePass2" id="pppoePass2" maxlength=31 style="width:200px;"
                        ...
                        <tr>
                          <td colspan="2" class="tabal_right" id="wPppoeCon_retryPeriod_td"><span id="wPppoeCon_retryPeriod_title">Keep Alive Mode: Retry Period</span>
                            ...
                            <span id="wPppoeCon_retryPeriod_tips" style="display: none">Seconds (10-99999)</span> </td>
                        </tr>
                        ...
                        <tr id="tr_ppp_outtime" style="display:none">
                          ...
                          <td class="tabal_right"><input type="text" name="ppp_outtime" id="ppp_outtime" maxlength="5" size="5">
                            <span id="wPppoeCon_retryPeriod_tips">Seconds (30-60000)</span> </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td colspan="2"><!--add begin by 吴小娟, 20110427, 原因: 新增PPPOE连接状态及IP;20110510, 原因:新增PPPOE连接DNS等-->
                            ...
                            <!--add end by 吴小娟, 20110427 --></td>
                        </tr>
                        <tr>
                          <td colspan="2"><table id="pppoe_ipv6" class="tabal_bg" border="0" cellpadding="0" cellspacing="1" width="100%" style="display: none;" >
                              <tbody>
                                <tr>
