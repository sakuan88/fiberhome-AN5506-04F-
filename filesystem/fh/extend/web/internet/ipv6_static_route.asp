...
function selectLine(id)
{
	...
	if (objTR != null)
	{
		...
		{
			document.getElementById("pt_DstPrefix").value = document.getElementById("ipv6_dstPrefix_" + temp).innerHTML;
			document.getElementById("pt_Nexthop").value = document.getElementById("ipv6_nexthop_" + temp).innerHTML;
...
//	if(confirm("你确认删除所选规则?") == false)
	...
	document.location = "/goform/ipv6_s_routeDeleteAll";	
}
