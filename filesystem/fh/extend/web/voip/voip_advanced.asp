...
/*modify begin by 陈鹏，20180803 原因:菲律宾GLOBE加载voip_globe.xml,其他版本加载voip_xml*/
if(ispNameCode == 15)  
{
	Butterlate.setTextDomain("voip_globe", lang);
}
else
{
...
function LoadFrame()
{
	...
	if(ispNameCode == '26')	//add by wuxj, 20171226, for TIM
	{
		...
		setDisplay("tr_tran_title", "none");
		setDisplay("tr_alivetype_title", "none");
	}
	...
	/* add begin by 陈鹏, 20180514, 原因: 马电TM SIP Advanced页面新增舒适噪声使能参数 */ 	
	/* 马电 TM 增加舒适噪声port1使能开关 */
	if(ispNameCode == '21')
	{
		setDisplay("tr_cng_title", "");

		var get_cng_enable = '<% getCfgGeneral(1, "cng_enable"); %>';
		var cng_enable = document.getElementById("cng_enable");
		for(var i = 0; i< cng_enable.length; i++)
		{	
			if(cng_enable.options[i].value == get_cng_enable)
			{
				cng_enable.options[i].selected = true;
				break;
			}
		}	
	}
	/* add end by 陈鹏,20180514 */
	...
	if(voip_port_num == 2)
	{
		...
		/* add begin by 陈鹏, 20180514, 原因: 马电TM SIP Advanced页面新增舒适噪声使能参数 */ 
		/* 马电 TM 增加舒适噪声port2使能开关 */
	    if(ispNameCode == '21')
		{
			setDisplay("tr_cng_title2", "");
			var get_cng_enable2 = '<% getCfgGeneral(1, "cng_enable2"); %>';
			var cng_enable2 = document.getElementById("cng_enable2");
			for(var i = 0; i< cng_enable2.length; i++)
			{	
				if(cng_enable2.options[i].value == get_cng_enable2)
				{
					cng_enable2.options[i].selected = true;
					break;
				}
			}
	    }
  ...
  <table class="tabal_bg" id="voipback" border="0" cellpadding="0" cellspacing="1" width="100%">
    <tbody>
      <tr id="tr_RFC2833_title">
        <td id="RFC2833_title" class="tabal_left" width="30%">RFC2833 PT Value</td>
      ...
      <tr id="tr_RFC2198_title">
        <td id="RFC2198_title" class="tabal_left" width="30%">RFC2198 PT Value</td>
      ...
      <tr id="tr_alive_time_title">
        <td id="alive_time_title" class="tabal_left" width="30%">Alive Times</td>
      ...
      <tr id="tr_alive_title">
        <td id="alive_title" class="tabal_left" width="30%">Alive Interval</td>
      ...
      <tr id="tr_fox_title">
        <td id="fox_title" class="tabal_left" width="30%">Fax Mode</td>
      ...
      <tr id="tr_fanji_title">
        <td id="fanji_title" class="tabal_left" width="30%">ReversedPolarity</td>
      ...
      <tr id="tr_tran_title">
        <td id="tran_title" class="tabal_left" width="30%">Character Escape Mode</td>
      ...
      <tr id="tr_dtmf_title">
        <td class="tabal_left" id="dtmf_title" width="30%">DTMF Mode</td>
      ...
      <!--tr>
	<td class="tabal_left" width="30%">启用同步话机时间:</td>
  	 <td class="tabal_right" align="left">自动</td>    
	</tr>
		<tr>
	 <td class="tabal_left" width="30%">订阅开关:</td>
  	 <td class="tabal_right" align="left">打开</td>    
	</tr>
	<tr>
	 <td class="tabal_left" width="30%">URL格式:</td>
  	 <td class="tabal_right" align="left">SIP</td>    
	</tr>
	<tr>
	 <td class="tabal_left" width="30%">传真控制方式:</td>
  	 <td class="tabal_right" align="left">软交换全控模式</td>    
	</tr>

	<tr>
	 <td class="tabal_left" width="30%">编解码和打包周期协商模式:</td>
     <td class="tabal_right">远端优先</td>
	</tr-->
      <tr id="tr_num_disptype_title">
        <td id="num_disptype_title" class="tabal_left" width="30%">Caller-ID Head Field</td>
      ...
      <tr id="tr_alivetype_title">
        <td id="alivetype_title" class="tabal_left" width="30%">Keepalive Mode</td>
      ...
      <tr id="tr_localPort_title">
        <td id="localPort_title" class="tabal_left" width="30%">Local Port</td>
      ...
      <tr id="tr_call_type" style="display: none">
        <td id="num_disp_title" class="tabal_left" width="30%">CallerIDMode</td>
      ...
      <tr id="tr_voipback_title">
        <td class="tabal_left" id="voipback_title" width="30%">EchoCancel</td>
      ...
      <tr id="tr_SilenceSuppression_title">
        <td id="SilenceSuppression_title" class="tabal_left" width="30%">Silence Suppression</td>
      ...
      <tr>
        <td id="callwait_title" class="tabal_left" width="30%">Call-waiting</td>
      ...
      <tr>
        <td id="3call_title" class="tabal_left" width="30%">Call Conference</td>
      ...
      <tr id="tr_set_gain_title">
        <td id="set_gain_title" class="tabal_left" width="30%">Output Gain</td>
      ...
      <tr id="tr_rec_gain_title">
        <td id="rec_gain_title" class="tabal_left" width="30%">Input Gain</td>
        <td class="tabal_right"><input name="rec_gain1" id="rec_gain1" size="8" maxlength="4" type="text" value="<% getCfgGeneral(1, "rec_gain1"); %>">
          <strong style="color:#FF0033">*</strong><span class="gray">(-12~6)</span></td>
      </tr>
      <tr id="tr_cng_title"  style="display: none">
        <td id="cng_title" class="tabal_left" width="30%">Comfort Noise Generation</td>
        <td class="tabal_right" align="left"><select name="cng_enable" id="cng_enable" size="1" style="width:200px;">
            <option id="cng_enable" value="1" selected="selected">Enable</option>
            <option id="cng_disable" value="0">Disable</option>
          </select></td>
      </tr>
    </tbody>
  </table>
  <table id="Voipport_2table" class="tabal_bg" border="0" cellpadding="0" cellspacing="1" width="100%">
    <tbody>
      <tr id="tr_voipback_title2">
        <td class="tabal_left" id="voipback_title2" width="30%">EchoCancel(port 2)</td>
      ...
      <tr id="tr_SilenceSuppression2_title">
        <td id="SilenceSuppression2_title" class="tabal_left" width="30%">Silence Suppression(port 2)</td>
      ...
      <tr>
        <td id="callwait_title2" class="tabal_left" width="30%">Call-waiting(port 2)</td>
      ...
      <tr>
        <td id="3call_title2" class="tabal_left" width="30%">Call Conference(port 2)</td>
      ...
      <tr id="tr_num_disp_title2">
        <td id="num_disp_title2" class="tabal_left" width="30%">CallerIDMode(port 2)</td>
      ...
      <tr id="tr_set_gain_title2">
        <td id="set_gain_title2" class="tabal_left" width="30%">Output Gain(port 2)</td>
      ...
      <tr id="tr_rec_gain_title2">
        <td id="rec_gain_title2" class="tabal_left" width="30%">Input Gain(port 2)</td>
        <td class="tabal_right"><input name="rec_gain2" id="rec_gain2" size="8" maxlength="4" type="text" value="<% getCfgGeneral(1, "rec_gain2"); %>">
          <strong style="color:#FF0033">*</strong><span class="gray">(-12~6)</span></td>
      </tr>
      <tr id="tr_cng_title2"  style="display: none">
        <td id="cng_title2" class="tabal_left" width="30%">Comfort Noise Generation(port 2)</td>
        <td class="tabal_right" align="left"><select name="cng_enable2" id="cng_enable2" size="1" style="width:200px;">
            <option id="cng_enable2" value="1" selected="selected">Enable</option>
            <option id="cng_disable2" value="0">Disable</option>
          </select></td>
      </tr>
    </tbody>
  </table>
