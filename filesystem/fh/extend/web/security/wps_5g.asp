...
var wps_enable_sync_ex = '<% wps_enable_sync_ex(); %>';
var WPSconnectSync_ex = '<% wps_connectsync_ex(); %>';
...
{
	initTranslation();	
	var wpsstate = '<% getCfgZero(1, "wps_state_5g"); %>';
	var wpsstate_input = document.getElementById("wps_state");
	var wps_enable = '<% getCfgZero(1, "wps_enable_5g"); %>';
	var wps_enalbe_node = document.getElementsByName("wpsEnable");

	showRadioNodeByValue(wps_enalbe_node, wps_enable);
...
<form method= "post" name="wps_enable" action="/goform/set_wps_enable_ex">
...
<form method="post" name="wps" action="/goform/set_wpsconnect_ex" onSubmit="return CheckValue();">
     ...
     <tr>
      ...
      <tr>
        <td class="tabal_right" colspan="6" align="left" ><input checked="checked" value = "pin" name="wps_style" id="wps_style_p"  type="radio">
          <font id="wps_PINtitel">Please input PIN code</font>
          &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        </td>
      </tr>
      <tr>
       <td class="tabal_left" width="6%" id="wps_PINer">PIN Code:</td>
       <td class="tabal_right"><input name="wps_PIN" id="wps_PIN" size="15" maxlength="8" type="text"> </td>
      </tr>
      <tr>
        <td class="tabal_right" colspan="6" align="left" ><input value = "button" name="wps_style" id="wps_style_b" type="radio">
          <font id="wps_buttontitel">Please turn on the button of the equipment.</font>
          &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        </td>
      </tr>
