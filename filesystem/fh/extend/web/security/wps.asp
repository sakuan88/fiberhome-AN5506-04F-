...
function initValue()
{
	...
	var wps_enable = '<% getCfgZero(1, "wps_enable"); %>';
  ...
  <table id="wps_bandSelec_table" class="tabal_bg" border="0" cellpadding="0" cellspacing="1" width="100%" style="display: none;" >
    <tbody>
      ...
      <tr>
        ...
        <td class="tabal_right" align="left" width="75%"><input checked="checked" value="0" name="wifi_band" type="radio">
          <font id="wps_band2.4g_font">2.4G</font> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
          <input value="1" name="wifi_band" type="radio">
    ...
    <table  id="tb_wps_cfg1" class="tabal_bg" border="0" cellpadding="0" cellspacing="1" width="100%">
      <tbody>
        ...
        <tr>
          ...
          <td class="tabal_right"><input name="wps_PIN" id="wps_PIN" size="15" maxlength="8" type="text">
          </td>
        </tr>
        <tr>
