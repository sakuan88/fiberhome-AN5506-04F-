...
var PortScanSync = '<% DdosSync(); %>';

function initTranslation()
{
	var e = document.getElementById("pro_ddos_prompt");
	e.innerHTML = _("pro_ddos_prompt");
...
{
	initTranslation();
	var Pro_PortScanning = document.getElementsByName("Pro_DDOSEnable");	
	for(var i = 0;i<Pro_PortScanning.length;i++)
	{
		if(Pro_PortScanning[i].value == '<% getCfgGeneral(1, "Pro_ddosEnable"); %>')
		{
...
<form method=post name="pro_PortScan_basic" action="/goform/setDDOSEnable">
    ...
    <tbody>
      <tr>
        <td class="prompt"><table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tbody>
              <tr>
                <td id="pro_ddos_prompt" class="title_01" style="padding-left: 10px;" width="100%"></td>
              </tr>
            </tbody>
          </table></td>
      </tr>
  ...
  <table class="tabal_bg" border="0" cellpadding="0" cellspacing="1" width="100%">
    <tbody>
      <tr>
        <td class="tabal_left" id="pro_ddos_title" align="left" width="25%">DDOS</td>
        <td class="tabal_right" colspan="6" align="left" width="75%"><input checked="checked" value="enable" name="Pro_DDOSEnable" type="radio">
          <font id="pps_enable">enable</font>
          &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
          <input value="disable" name="Pro_DDOSEnable" type="radio">
