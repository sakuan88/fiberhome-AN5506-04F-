...
{ 
	initTranslation();
	if(ispNameCode == '5' || ispNameCode == '28')	//AIS/墨西哥TOTALPLAY
	{
...
function selectLine(id)
{
	...
	if (objTR != null)
	{
		...
		{
			document.getElementById("account_user").value = getElement("user_" + temp).innerHTML;
			if(ispNameCode != '5' && ispNameCode != '28')	//not AIS/墨西哥TOTALPLAY
			{
                              ...
                              <table class="tabal_bg" cellpadding="0" cellspacing="1" width="100%">
                                <tbody>
                                  ...
                                  <tr id="tr_pwd" style="">
                                    ...
                                    <td class="tabal_right" width="75%"><input name="account_pwd" id="account_pwdText" type="text" size="15" maxlength="32" style="width: 150px;">
                                    <input name="account_pwd" id="account_pwdPwd" type="password" size="15" maxlength="32" style="width: 150px;">
                                  ...
                                  <tr id="tr_pwd2" style="">
                                    ...
                                    <td class="tabal_right" width="75%"><input name="account_pwd2" id="account_pwd2Text" type="text" size="15" maxlength="32" style="width: 150px;">
                                    <input name="account_pwd2" id="account_pwd2Pwd" type="password" size="15" maxlength="32" style="width: 150px;">
