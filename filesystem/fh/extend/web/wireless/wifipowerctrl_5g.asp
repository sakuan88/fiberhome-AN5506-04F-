...
<form method=post name="wifi_power" action="/goform/setWifiPowerEx">
...
<form method=post name="wifi_power" action="/goform/setWifiConNumEx" onSubmit="return CheckValue()">
