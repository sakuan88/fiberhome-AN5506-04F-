...
<form method="post" name="security_form" id="security_form" action="/goform/APSecurity">
  ...
  <table id="MBSSID" class="tabal_bg" border="0" cellpadding="0" cellspacing="1" width="100%">
    <tbody>
      <tr class="tabal_head">
        <td colspan="2" id="secureSelectSSID">Select SSID</td>
      </tr>
      <tr>
        ...
        <td class="tabal_right" colspan="6" align="left" width="35%"><input checked="checked" value="enable" name="SSIDEnable" type="radio">
  ...
  <table id="MBSSID" class="tabal_bg" border="0" cellpadding="0" cellspacing="1" width="100%">
    ...
    <tr id="tr_wmm" style="display: none;">
      ...
      <td class="tabal_right" colspan="3"><input type="checkbox" name="secure_WMM" value="1">
      </td>
    </tr>
    </tbody>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td width="25%" class="tabal_right"><input name="WEP1" id="WEP1Text" type="text" maxlength="26" value="" onKeyUp="setChange(1)">
          <input name="WEP1" id="WEP1Pwd" type="password" maxlength="26" onKeyUp="setChange(1)" onfocus="clearInputValue(this.id)" onblur="resetInputValue(this.id)"></td>
      ...
      <tr>
        ...
        <td class="tabal_right"><input name="WEP2" id="WEP2Text" type="text" maxlength="26" value="" onKeyUp="setChange(1)">
          <input name="WEP2" id="WEP2Pwd" type="password" maxlength="26" onKeyUp="setChange(1)" onfocus="clearInputValue(this.id)" onblur="resetInputValue(this.id)"></td>
      ...
      <tr>
        ...
        <td class="tabal_right"><input name="WEP3" id="WEP3Text" type="text" maxlength="26" value="" onKeyUp="setChange(1)">
          <input name="WEP3" id="WEP3Pwd" type="password" maxlength="26" onKeyUp="setChange(1)" onfocus="clearInputValue(this.id)" onblur="resetInputValue(this.id)"></td>
      ...
      <tr>
        ...
        <td class="tabal_right"><input name="WEP4" id="WEP4Text" type="text" maxlength="26" value="" onKeyUp="setChange(1)">
          <input name="WEP4" id="WEP4Pwd" type="password" maxlength="26" onKeyUp="setChange(1)" onfocus="clearInputValue(this.id)" onblur="resetInputValue(this.id)"></td>
  ...
  <table id="div_wpa" name="div_wpa" class="tabal_bg" border="0" cellpadding="0" cellspacing="1" width="100%" style="visibility: hidden;">
    <tbody>
      ...
      <tr id="div_wpa_algorithms" name="div_wpa_algorithms" style="visibility: hidden;">
        ...
        <td class="tabal_right"><input name="cipher" id="cipher" value="0" type="radio" onClick="onWPAAlgorithmsClick(0)">
          TKIP &nbsp;
      ...
      <tr id="wpa_passphrase" name="wpa_passphrase" style="visibility: hidden;">
        <td class="tabal_left" width="25%" id="secureWPAPassPhrase">Passphrase</td>
        <td class="tabal_right"><input name="passphrase" id="passphraseText" type="password" size="28" maxlength="64" value="" onKeyUp="setChange(1)">
          <input name="passphrase" id="passphrasePwd" type="password" size="28" maxlength="64" onKeyUp="setChange(1)" onfocus="clearInputValue(this.id)" onblur="resetInputValue(this.id)">
      ...
      <tr id="wpa_preAuthentication" name="wpa_preAuthentication" style="visibility: hidden;">
        ...
        <td class="tabal_right"><input name="PreAuthentication" id="PreAuthentication" value="0" type="radio" onClick="onPreAuthenticationClick(0)">
  ...
  <table id="div_8021x_wep" name="div_8021x_wep" class="tabal_bg" border="0" cellpadding="0" cellspacing="1" width="100%" style="visibility: hidden;">
    <tbody>
      ...
      <tr>
        ...
        <td class="tabal_right"><input name="ieee8021x_wep" id="ieee8021x_wep" value="0" type="radio" onClick="onIEEE8021XWEPClick(0)">
