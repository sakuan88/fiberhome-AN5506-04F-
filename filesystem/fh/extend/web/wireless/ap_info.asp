...
function initTranslation()
{
	...
	if(ispName == 28)
	{
		e.innerHTML = _("wifi_apPrompt1");
	}
	else
	{
		e.innerHTML = _("wifi_apPrompt2");
	}
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td class="prompt"><table border="0" cellpadding="3" cellspacing="3" width="100%">
          <tbody>
            <tr>
              <td id="wifi_apPrompt" class="title_01" style="padding-left: 10px;" width="100%"></td>
            </tr>
          </tbody>
        </table></td>
    </tr>
          ...
          <tbody>
            <tr height="22">
              <td align="left"><table border="0" cellpadding="0" cellspacing="0">
                  <tbody>
                    <tr>
                      <td><input type="reset" value="Refresh" id="ap_refresh" class="submit" onClick="window.location.reload();"/></td>
                    </tr>
                  </tbody>
                </table></td>
            </tr>
