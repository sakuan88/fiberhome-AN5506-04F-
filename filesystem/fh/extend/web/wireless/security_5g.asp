...
<script type="text/javascript" src="/js/wifisecurity_5g.js"></script>
...
var ssid_arr = '<% getCfgGeneral(1, "ssidName");%>';
...
var Have_RADIUS = '<% getCfgGeneral(1, "RADIUS"); %>';

var WEB_WIFI_CERTIFIED_OPTION = '<% getCfgGeneral(1, "WEB_WIFI_CERTIFIED_OPTION");%>';
var wifi_dual_ssid_num = '<% getCfgGeneral(1, "wifi_dual_ssid_num"); %>';
...
<form method="post" name="security_form" id="security_form" action="/goform/APSecurityEx">
