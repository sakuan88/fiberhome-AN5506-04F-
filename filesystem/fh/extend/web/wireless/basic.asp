...
var wifi_chip_num = '<% getCfgZero(1, "wifi_chip_num"); %>';
...
<form method="post" name="wireless_basic" id="wireless_basic" action="/goform/wirelessBasic" onSubmit="return CheckValue()">
  ...
  <table class="tabal_bg" border="0" cellpadding="0" cellspacing="1" width="100%">
    <tbody>
      ...
      <tr id="div_basicDomain" name="div_basicDomain">
      ...
      <tr>
        ...
        <td class="tabal_right"><select name="Fre_band" id="Fre_band" size="1">
            <option value=0 selected="selected">20MHz/40MHz</option>
      ...
      <tr id="tr_guard_inter" style="display:none">
