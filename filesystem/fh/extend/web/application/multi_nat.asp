...
function selectLine(id)
{
	...
	if (objTR != null)
	{
		...
		{
			document.getElementById("mn_Description").value = document.getElementById("pt_Description_" + temp).innerHTML;
			
			document.getElementById("mn_locips").value = document.getElementById("pt_locips_" + temp).innerHTML;
			document.getElementById("mn_locip_e").value = document.getElementById("pt_locipe_" + temp).innerHTML;
			document.getElementById("mn_pubips").value = document.getElementById("pt_pubips_" + temp).innerHTML;
			document.getElementById("mn_pubipe").value = document.getElementById("pt_pubipe_" + temp).innerHTML;
			document.getElementById("pt_ruletype_" + temp).innerHTML;
...
//	if(confirm("你确认删除所选规则?") == false)
	...
	document.location = "/goform/Muti_NatDeleteAll";    	
