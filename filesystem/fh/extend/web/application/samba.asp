...
function selectLine(id)
{
	...
	if (objTR != null)
	{
		...
		else
		{
			...
			document.getElementById("samba_username").value = document.getElementById("samba_username_" + temp).innerHTML;
			document.getElementById("samba_password").value = samba_password_all_index[temp];
			document.getElementById("samba_directory").value = document.getElementById("samba_shareDir_" + temp).innerHTML;
...
//	if(confirm("你确认删除所选规则?") == false)
	...
	document.location = "/goform/samba_deleteall";	
}
