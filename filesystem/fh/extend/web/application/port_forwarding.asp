...
function selectLine(id)
{
	...
	if (objTR != null)
	{
		...
		{
			document.getElementById("pf_Description").value = document.getElementById("pf_description_" + temp).innerHTML;
			...
			document.getElementById("pf_IP").value = document.getElementById("pf_ip_" + temp).innerHTML;
...
//	if(confirm("你确认删除所选规则?") == false)
	...
	document.location = "/goform/portforwardingDeleteAll";    
          ...
          <table class="tabal_bg" id = "fw_ruletable" border="0" cellpadding="0" cellspacing="1" width="100%">
            <tbody>
              ...
              <tr class="tabal_title">
                <td width="9%" align="center" id="PFwan">WAN</td>
                <td width="12%" align="center" id="PFdescrip">Description</td>
                <td width="16%" align="center" id="The_public_Port">Public Port</td>
                <td width="13%" align="center">IP</td>
                <td width="16%" align="center" id="The_private_Port">Private Port</td>
