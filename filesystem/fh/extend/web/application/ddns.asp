...
{
	document.location = "/goform/ddnsDele";
}
...
function initValue()
{
	...
	/*add begin by 陈鹏，20181122，原因:墨西哥要求DDNS域名有www.3232.org改为www.pubyun.com，需求来源:肖保平*/
	if((ispNameCode == 28))
	{
		ddnsprovidernode.options[0].text = "www.pubyun.com";
	}

	/*add end by 陈鹏，20181122*/
...
/*
	...
	if(ddns_provider.value== 3) // ddns_provider.value=3表示ddns_provider为Other
	{
		...
		if(ddns_protocolnode.value  == 2) //ddns_protocolnode.value= 2表示ddns_protocol为GNUDip.http
		{
...
function ProtocolTypeSwitch()
{
	...
	if(ddns_protocol.value == 2) //ddns_protocolnode.value= 2表示ddns_protocol为GNUDip.http
	{
  ...
  <table class="tabal_bg" border="0" cellpadding="0" cellspacing="1" width="100%">
    <tbody>
      ...
      <tr>
        ...
        <td class="tabal_right"><input name="ddns_username" id="ddns_username" size="15" maxlength="32" type="text" value="<% getCfgGeneral(1, "ddns_username"); %>">
      ...
      <tr>
        ...
        <td class="tabal_right"><input name="ddns_password" id="ddns_password" size="15" maxlength="32" type="password" value="<% getCfgGeneral(1, "ddns_password_encode"); %>" onFocus="clearInputValue(this.id)" onBlur="resetInputValue(this.id)">
      ...
      <tr>
        ...
        <td class="tabal_right"><select id="ddns_provider" name="ddns_provider" size="1" style="width:35%" onChange="ProviderTypeSwitch();">
            <option value="0" selected="selected">www.3232.org</option>
