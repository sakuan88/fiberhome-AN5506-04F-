...
//			showSelectNodeByValue(wanNode, curWan);
			...
			getElement("pm_description").value = getElement("pm_description_" + temp).innerHTML;
			...
			getElement("pm_pubIP").value = getElement("pm_pubIP_" + temp).innerHTML;			
			...
			getElement("pm_priIP").value = getElement("pm_priIP_" + temp).innerHTML;
...
function clickRemoveAll(tabTitle)
{
	...
	document.location = "/goform/portMappingDeleteAll";    
