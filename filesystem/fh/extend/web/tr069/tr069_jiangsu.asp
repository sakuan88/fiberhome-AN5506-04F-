...
function initTranslation()
{
	...
	e.innerHTML = _("tr069_prompt_readonly");
...
function initValue()
{
	...
	document.getElementsByName("tr069url")[0].disabled = 1;
	document.getElementsByName("tr069Enable")[0].disabled = 1;
	document.getElementsByName("tr069Enable")[1].disabled = 1;
	document.getElementsByName("tr069userName")[0].disabled = 1;
	document.getElementsByName("tr069password")[0].disabled = 1;
	document.getElementsByName("tr069path")[0].disabled = 1;
	document.getElementsByName("tr069port")[0].disabled = 1;
	document.getElementById("tr069authCheckbox").disabled = 1;
	document.getElementsByName("tr069conReqUsr")[0].disabled = 1;
	document.getElementsByName("tr069conReqPwd")[0].disabled = 1;
	document.getElementsByName("tr069InformEnable")[0].disabled = 1;
	document.getElementsByName("tr069InformEnable")[1].disabled = 1;
	document.getElementsByName("tr069InformInterval")[0].disabled = 1;
}
  ...
  <tbody>
    <tr>
      <td class="prompt"><table border="0" cellpadding="0" cellspacing="0" width="100%">
          <tbody>
            <tr>
              <td id="tr069_prompt"  class="title_01" style="padding-left: 10px;" width="100%"> 在本页面上，您可以配置TR069的URL、用户名、密码、连接请求用户名、连接请求密码等。 </td>
            </tr>
          </tbody>
        </table></td>
    </tr>
    ...
    <tbody>
      <tr>
        ...
        <td class="tabal_right" colspan="6" align="left" width="75%"><input checked="checked" value="enable" name="tr069Enable" type="radio">
          <font id="tr069_enable">启用</font> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
          <input value="disable" name="tr069Enable" type="radio">
          <font id="tr069_disable">禁用</font><strong style="color:#FF0033">&nbsp; &nbsp; &nbsp;*</strong> </td>
      </tr>
  </table>
  <!--table class="tabal_button" border="0" cellpadding="0" cellspacing="1" width="100%">
    <tbody>
      <tr>
        ...
        <td class="tabal_submit" align="left"><input class="submit" type="submit" value="提交" id="tr069EnableApply">
          &nbsp; &nbsp;
          <input class="submit" type="reset" value="取消" id="tr069EnableCancel" onClick="window.location.reload()">
        </td>
      </tr>
    </tbody>
  </table-->
...
<form method=post name="fm_tr069_basic" action="/goform/setTR069Basic" onSubmit="return CheckValue()">
  <table class="tabal_bg" border="0" cellpadding="0" cellspacing="1" width="100%">
    <tbody>
      ...
      <tr>
        <td class="tabal_left" id="tr069userName_title" align="left" width="25%">用户名</td>
      ...
      <tr>
        <td class="tabal_left" id="tr069password_title" align="left" width="25%">密码</td>
       ...
       <tr>
        <td class="tabal_left" id="ConnectionRequestPath_title" align="left" width="25%">连接请求路径</td>
        ...
        <tr>
        <td class="tabal_left" id="ConnectionRequestPort_title" align="left" width="25%">连接请求端口</td>
      ...
      <tr>
        <td id="tr069conReqUsr_title" class="tabal_left" align="left" width="25%">反向连接用户名</td>
      ...
      <tr>
        <td class="tabal_left" id="tr069conReqPwd_title" align="left" width="25%">反向连接密码</td>
      ...
      <tr>
        <td class="tabal_left" id="tr069InformEnable_title" align="left" width="25%">通知使能</td>
        <td class="tabal_right" colspan="6" align="left" width="75%"><input checked="checked" value="1" name="tr069InformEnable" type="radio">
          <font id="tr069Inform_enable">启用</font> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
          <input value="0" name="tr069InformEnable" type="radio">
          <font id="tr069Inform_disable">禁用</font><strong style="color:#FF0033">&nbsp; &nbsp; &nbsp;*</strong> </td>
      </tr>
      <tr>
        <td class="tabal_left" id="tr069InformInterval_title" align="left" width="25%">通知间隔</td>
  ...
  <!--table class="tabal_button" border="0" cellpadding="0" cellspacing="1" width="100%">
    <tbody>
      <tr>
        <td class="tabal_submit" width="25%"></td>
        <td class="tabal_submit" align="left"><input class="submit" type="submit" value="提交" id="tr069BasicApply">
          &nbsp; &nbsp;
          <input class="submit" type="reset" value="取消" id="tr069BasicCancel" onClick="window.location.reload()">
          &nbsp; &nbsp;
          <input class="submit" type="button" value="获取RPC方法" id="tr069GetRPCMethods" onClick="getRPCMethods()">
        </td>
      </tr>
      <tr>
