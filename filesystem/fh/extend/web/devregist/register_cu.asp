...
function LoadFrame()
{
	...
	{
		document.getElementById("LOPWD").disabled = 1;
	}
	else
	{
		document.getElementById("LOPWD").disabled = 0;
	}
					...
					case 0:
						switch(parseInt(authResult))
						{
							...
							case 0:
								...
								break;
							case 1:
								codeTxt = "注册全部完成，业务下发配置成功，欢迎使用中国联通的通信业务";
								break;
							case 2:
								codeTxt = "注册成功，下发业务失败。";
								break;
...
function showResult(){	
	if(count > 3000) {								//2400	--8分钟	//2011-10-13应丰工要求修改为10分钟
		...
		document.getElementById("information").innerHTML = 
			"<a href=\"/devregist/register_cu.asp\">注册超时！请检查线路后重试。</a>";
	}else{
...
<form>
  <table align="center" border="0" cellpadding="0" cellspacing="0" height="768" width="1024">
    <tbody>
      <tr>
        <td><table align="middle" background="../images/login_per_admin.png" border="0" cellpadding="0" cellspacing="0" height="427" width="950">
            <tbody>
              <tr>
                <td width="42%"><table valign="middle" height="100%" width="100%" >
                    <tbody>
                    </tbody>
                  </table></td>
                <td width="58%"><table valign="middle" height="100%" width="96%" >
                    <tbody>
                      <tr>
                        <td width="100%" height="12%"><table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%">
                            <tbody>
                              <tr>
                      ...
                      <tr >
                        <td width="100%" height="88%"><table id="tb_register" border="0" cellpadding="0" cellspacing="0" height="200" width="400" style="display:none">
                            <tbody>
                              <tr>
                          ...
                          <table id="tb_progressBar" align="center" border="0" cellpadding="0" cellspacing="0" height="80%" width="400">
                            <tbody>
                              ...
                              <tr>
                                <td colspan="2" id="information" align="center" height="20" width="100%">终端正在向OLT注册</td>
                              </tr>
                              <tr>
                                <td colspan="2" align="center" height="20" width="100%"><font size="2"> </font></td>
                              </tr>
