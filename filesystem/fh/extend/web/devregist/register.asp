...
function initTranslation()
{
	...
	e = document.getElementById("loidTitle");
	e.innerHTML = _("loidTitle");
			...
			else
			{
				...
				switch(parseInt(authStatus))
				{
					case 0:
						...
						break;
					case 1:
						codeTxt = _("ACSAuthFailed_pwd") + codeTxt2;//"用户认证码不存在。"
						break;
					case 2:
						codeTxt = _("ACSAuthFailed_loid") + codeTxt2;//"用户逻辑ID不存在。"
						break;
					case 3:
						codeTxt = _("ACSAuthFailed_loidpwd") + codeTxt2;//"用户逻辑ID与用户认证码匹配失败。"
						break;
					case 4:
...
{	
	with ( document.forms[0] ) 
	{
		if(LOID.value.length <= 0) {
			alert( _("loidNullAlert"));	//"逻辑ID为空，请输入逻辑ID!"
			return false;
		}
...
function showResult(){	
	if(count > 3000) {								//2400	--8分钟	//2011-10-13应丰工要求修改为10分钟
		...
		document.getElementById("information").innerHTML = 
			"<a href=\"/devregist/register.asp\">" + _("registTimeout") + "</a>";
	}else{
                ...
                <td id="registBgimg" align="center" height="323" width="653"><table border="0" cellpadding="0" cellspacing="0" height="50" width="96%">
                  ...
                  <table id="tb_register" border="0" cellpadding="0" cellspacing="0" height="200" width="400" style="display:none">
                    <tbody>
                      ...
                      <tr>
                        <td id="loidTitle" align="right" height="25" valign="bottom" width="130"></td>
                      ...
                      <tr>
                        <td id="pwdTitle" align="right" height="25" valign="top" width="130"></td>
