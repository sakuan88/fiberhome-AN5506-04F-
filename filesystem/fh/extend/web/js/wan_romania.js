...
function pppoemanual_connect(rs)
{
	...
	document.location = "/goform/ppp_manual_connect?fw_curIndex=" + fw_curIndex.value + "&ppphiddenButton=" + ppphiddenButton_node.value;
}
...
//			Tr069Wan_style(1);//internet
			showSelectNodeByValue(getElement("wan_connectionmode"),1)
...
{ 
	...
	if(ispName == 16)//越南HGU
	{
		...
		wan_connectionmodeNode.options[3].text="Multiscreen";
