...
function initTranslation()
{
	...
	if(ispName == '5' && curUserType == '1')	//HGU AIS普通用户
    ...
    <table class="tabal_bg" border="0" cellpadding="0" cellspacing="1" width="100%">
      <tbody>
        ...
        <tr id="TrLopwd">
          ...
          <td class="tabal_right"><input name="logic_pwd" id="logic_pwd" maxlength="12" type="password" value="<% getCfgGeneral(1, "logic_pwd"); %>">
  ...
  <form method="post" name="pwdcfgForm" id="pwdcfgForm">
    <table class="tabal_bg" border="0" cellpadding="0" cellspacing="1" width="100%">
      <tbody>
        ...
        <tr id="TrPassword">
          <td class="tabal_left" width="20%" id="sncfg_pwd">Password</td>
          <td class="tabal_right"><input name="pwd_cfg" id="pwd_cfg" maxlength="10" type="text" value="<% getCfgGeneral(1, "pwd_cfg"); %>">
...
<div id="div_restore" style="display: none">
  <table id="tb_submit" class="tabal_bg" border="0" cellpadding="0" cellspacing="0" width="100%">
    <tbody>
      <tr class="tabal_head">
